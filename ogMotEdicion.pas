...
procedure TModEdicion.AddGraphObject(og: TObjGraf; AutoPos: boolean = true);
...
procedure TModEdicion.DeleteAll;
...
procedure TModEdicion.SelectAll;
var s: TObjGraf;
begin
    For s In objetos do s.Selec; //selecciona todos
End;
procedure TModEdicion.UnselectAll;
var s: TObjGraf;
begin
...
End;
function  TModEdicion.Selected: TObjGraf;
...
procedure TModEdicion.ScrollDown(desp: Double = DESPLAZ_MENOR) ;  //abajo
...
procedure TModEdicion.ScrollUp(desp: Double = DESPLAZ_MENOR) ;  //arriba
//Genera un desplazamiento en la pantalla haciendolo independiente del
//factor de ampliación actual
var
    z: Single ;  //zoom
...
procedure TModEdicion.ScrollRight(desp: Double = DESPLAZ_MENOR) ;  //derecha
//Genera un desplazamiento en la pantalla haciendolo independiente del
//factor de ampliación actual
var
    z: Single ;  //zoom
...
procedure TModEdicion.ScrollLeft(desp: Double = DESPLAZ_MENOR) ;  //izquierda
//Genera un desplazamiento en la pantalla haciendolo independiente del
//factor de ampliación actual
var
    z: Single ;  //zoom
...
procedure TModEdicion.ScrollDesp(dx, dy: integer);
